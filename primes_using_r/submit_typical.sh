...
############################################################################
# Copy any input files from there to the scratch directory you created above
############################################################################

# You would put the commands to do that here.
# In this case we do not have any input files.

###############
# Start the Job
###############

# Change to the scratch directory. This is where your output files will be written to.
# files to before you start. Then run the primes program.
cd ${SCRATCH}
Rscript ${PBS_O_WORKDIR}/primes.r 100000 200000
